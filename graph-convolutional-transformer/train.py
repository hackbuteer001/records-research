...
def main(argv):
    ...
    # input_path = argv[1]
    # model_dir = argv[2]
    input_path = '/home/caoyu/project/records-research-GCT/graph-convolutional-transformer/eicu_samples/predata/fold_0'
    model_dir = '/home/caoyu/project/records-research-GCT/graph-convolutional-transformer/outputs'
    num_iter = 1000000
